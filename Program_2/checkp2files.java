public class checkp2files {
    public static void main(String[] args) {
        ...
        try {
            java.io.BufferedReader input1 = new java.io.BufferedReader(
                    new java.io.InputStreamReader(new java.io.FileInputStream(args[0])));
            java.io.BufferedReader input2 = new java.io.BufferedReader(
                    new java.io.InputStreamReader(new java.io.FileInputStream(args[1])));
